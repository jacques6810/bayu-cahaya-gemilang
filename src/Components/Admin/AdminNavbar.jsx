...
import IconWA from "../../assets/IconLogout.png";
import "../../App.css";
    ...
    >
      <div className="max-w-2xl md:max-w-4xl lg:max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <button
            type="button"
            className="flex items-center bg-red-500 text-xs md:text-sm tracking-widest font-semibold text-white rounded-lg text-sm px-4 py-1.5 md:px-5 md:py-2 text-center transform transition-transform duration-300 hover:scale-105"
          >
            <img
              src={IconWA}
              alt="Whatsapp Icon"
