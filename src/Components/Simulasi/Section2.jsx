  ...
  return (
    <div className="w-full bg-gray-200">
      <div className="flex flex-col items-center justify-center py-20 mx-20 mt-20">
        ...
        <div className="grid justify-center gap-2 my-10 gap-5 sm:gap-15 md:px-5 lg:px-20 lg:gap-20 items-center justify-items-center w-full object-cover grid-cols-3 md:grid-cols-5">
